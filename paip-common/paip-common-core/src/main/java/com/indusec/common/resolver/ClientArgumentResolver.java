package com.indusec.common.resolver;

import com.indusec.common.annotation.LoginClient;
...
public class ClientArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter methodParameter,
        ...
        if (StrUtil.isBlank(clientId)) {
            log.warn("ClientArgumentResolver.resolveArgument error clientId is empty");
        }
        return clientId;
    }
}
