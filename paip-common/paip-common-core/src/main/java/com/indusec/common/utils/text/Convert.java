package com.indusec.common.utils.text;
...
public class Convert {
    ...
    public static String utf8String(Object obj) {
        return string(obj, Charset.forName("UTF-8"));
    }
     ...
     * @return 字符串
     */
    public static String string(Object obj, String charsetName) {
        return string(obj, Charset.forName(charsetName));
    }
    ...
    public static String string(Object obj, Charset charset) {
        ...
        if (obj instanceof String) {
            ...
            return string((Byte[]) obj, charset);
        } else if (obj instanceof ByteBuffer) {
            return string((ByteBuffer) obj, charset);
        }
        return obj.toString();
    }
    ...
    public static String string(byte[] bytes, String charset) {
        return string(bytes, StringUtils.isEmpty(charset) ? Charset.defaultCharset() : Charset.forName(charset));
    }
