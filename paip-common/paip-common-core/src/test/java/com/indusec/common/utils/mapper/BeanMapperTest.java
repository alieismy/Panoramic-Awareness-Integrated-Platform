...
public class BeanMapperTest {
    ...
    public void copySingleObject() {
        Student student = new Student("zhang3", 20, new Teacher("li4"), ListUtil.toList("chinese", "english"));
    ...
    public void copyListObject() {
        Student student1 = new Student("zhang3", 20, new Teacher("li4"), ListUtil.toList("chinese", "english"));
        Student student2 = new Student("zhang4", 30, new Teacher("li5"), ListUtil.toList("chinese2", "english4"));
        Student student3 = new Student("zhang5", 40, new Teacher("li6"), ListUtil.toList("chinese3", "english5"));
        List<Student> studentList = ListUtil.toList(student1, student2, student3);
    ...
    public static class Student {
        ...
        private List<String> course = ListUtil.toList();
