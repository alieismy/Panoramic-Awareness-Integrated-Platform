...
import com.indusec.oauth2.common.util.JwtUtils;
...
import static com.indusec.oauth2.common.constants.IdTokenClaimNames.*;
...
public class OidcIdTokenBuilder {
     ...
     */
    public String build() {
        return JwtUtils.encodeStr(JsonMapper.INSTANCE.toJSON(claims), keyProperties);
    }
}
