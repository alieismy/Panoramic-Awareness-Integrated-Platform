...
import com.indusec.common.config.DefaultPasswordConfig;
import com.indusec.common.constant.SecurityConstants;
import com.indusec.common.properties.TenantProperties;
import com.indusec.oauth.filter.LoginProcessSetTenantFilter;
import com.indusec.oauth.mobile.MobileAuthenticationSecurityConfig;
import com.indusec.oauth.openid.OpenIdAuthenticationSecurityConfig;
...
import com.indusec.oauth.tenant.TenantAuthenticationSecurityConfig;
import com.indusec.oauth.tenant.TenantUsernamePasswordAuthenticationFilter;
...
/**
 * <p> Spring Security Web安全配置 </p>
 *
 * <p> 在WebSecurityConfigurerAdapter不拦截OAuth要开放的资源 </p>
 *
 * @author: L.J
